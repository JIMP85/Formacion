...
public class FilmEditDTO {
	...
	private int length;
	@Pattern(regexp = "^(G|PG|PG-13|R|NC-17)$") //Usa el pattern creado para el rating de peliculas
	...
	private List<Integer> actors = new ArrayList<Integer>(); //Lista de actores dentro de la pelicula
	private List<Integer> categories = new ArrayList<Integer>(); //List de categoría de la pelicula
